...
class PhotographsControllerTest < ActionController::TestCase
  ...
  test "should create photograph" do
    assert_difference('Photograph.count') do
      post :create, photograph: { comment: @photograph.comment, image: @photograph.image, photo_caption: @photograph.photo_caption, tags: @photograph.tags }
    end
  ...
  test "should update photograph" do
    put :update, id: @photograph, photograph: { comment: @photograph.comment, image: @photograph.image, photo_caption: @photograph.photo_caption, tags: @photograph.tags }
    assert_redirected_to photograph_path(assigns(:photograph))
  end
